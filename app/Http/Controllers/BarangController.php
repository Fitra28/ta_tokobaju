...
class BarangController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        DB::insert('INSERT INTO barang(id_barang, nama_barang, harga, stok) VALUES (:id_barang, :nama_barang, :harga, :stok)',
        [
    ...
    public function update($id, Request $request) {
        ...
        // Menggunakan Query Builder Laravel dan Named Bindings untuk valuesnya
        DB::update('UPDATE barang SET id_barang = :id_barang, nama_barang = :nama_barang, harga = :harga, stok = :stok WHERE id_barang = :id',
        [
            'id' => $id,
            'id_barang' => $request->id_barang,
            'nama_barang' => $request->nama_barang,
