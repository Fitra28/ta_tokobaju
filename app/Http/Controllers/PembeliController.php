...
class PembeliController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        DB::insert('INSERT INTO Pembeli(id_pembeli, nama, no_telp, alamat) VALUES (:id_pembeli, :nama, :no_telp, :alamat)',
        [
    ...
    public function update($id, Request $request) {
        ...
        // Menggunakan Query Builder Laravel dan Named Bindings untuk valuesnya
        DB::update('UPDATE Pembeli SET id_pembeli = :id_pembeli, nama = :nama, no_telp = :no_telp, alamat = :alamat WHERE id_pembeli = :id',
        [
            'id' => $id,
            'id_pembeli' => $request->id_pembeli,
            'nama' => $request->nama,
