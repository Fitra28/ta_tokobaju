...
class TransaksiController extends Controller

    {
        ...
        public function store(Request $request) {
            ...
            DB::insert('INSERT INTO transaksi(id_transaksi, id_barang, id_pembeli, tanggal) VALUES (:id_transaksi, :id_barang, :id_pembeli, :tanggal)',
            [    
        ...
        public function update($id, Request $request) {
            ...
            // Menggunakan Query Builder Laravel dan Named Bindings untuk valuesnya
            DB::update('UPDATE Transaksi SET id_transaksi = :id_transaksi, id_barang = :id_barang, id_pembeli = :id_pembeli, tanggal = :tanggal WHERE id_transaksi = :id',
            [
                'id' => $id,
                'id_transaksi' => $request->id_transaksi,
                'id_barang' => $request->id_barang,
