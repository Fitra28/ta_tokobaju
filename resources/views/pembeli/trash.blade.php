...
<h2 class="mt-5 p-2 bg-white text-dark rounded-2">Kotak Sampah (Data Pembeli)</h2>
<div class="p-2 bg-white rounded-2">
    <h6 > Cari Data Pembeli :</h6>
	<form action="/pembeli/search" method="get" >
		<input class="p-1 rounded-3"type="text" name="search" placeholder="" value="{{ old('search') }}">
    ...
    <tbody>
        @foreach ($datas as $data)
            <tr>
                ...
                <td>
                <a href="{{ route('pembeli.restore', $data->id_pembeli) }}" type="button" class="btn btn-warning rounded-3"><i class="fa fa-pencil"></i>Restore</a>
...
<div class="card-footer">
    <a href="{{ route('pembeli.index') }}" type="button" class="mt-1 btn btn-primary p-2 rounded-3">Kembali</a>
</div>
@stop